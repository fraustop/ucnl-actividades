          ...
          {mode !== 'reset' && (
            <div className="space-y-3">
              <button
                ...
                className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-white hover:bg-slate-50 active:bg-slate-100 text-slate-700 text-sm font-bold rounded-2xl border border-slate-200 shadow-sm hover:shadow transition disabled:opacity-50 active:scale-95 cursor-pointer"
              >
                {googleLoading ? (
                  <>
              ...
              <div className="relative flex py-1 items-center">
                ...
                <span className="flex-shrink mx-3 text-slate-400 text-[11px] font-bold uppercase tracking-wider">o con correo</span>
                <div className="flex-grow border-t border-slate-200"></div>
              </div>
            </div>
          )}
