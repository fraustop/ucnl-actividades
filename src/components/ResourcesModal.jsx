...
export const ResourcesModal = ({
  ...
  return (
    <div className="fixed inset-0 z-[500] overflow-y-auto bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-3 sm:p-4 animate-in fade-in duration-200">
      <div 
